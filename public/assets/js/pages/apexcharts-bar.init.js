...
var options = {
    ...
    colors: ['#206bc4', '#963b68', '#eb9d59', '#62B7E5', '#29aa85'],
    xaxis: {
...
var options = {
    ...
    colors: ['#206bc4', '#6c757d', '#29aa85', '#8c57d1', '#29aa85'],
    stroke: {
        width: 1,
        colors: ['#fff']
    },
...
var options = {
    ...
    colors: ['#206bc4', '#5be7bd', '#eb9d59', '#8c57d1'],
    legend: {
        position: 'top',
        horizontalAlign: 'left'
    }
...
var options = {
    ...
    colors: ['#206bc4', '#522c8f', '#8c57d1', '#963b68', '#ec8290', '#29aa85', '#62B7E5', '#5be7bd',
        '#963b68', '#eb9d59'
    ],
    dataLabels: {
        enabled: true,
...
var options = {
    ...
    colors: ["#206bc4", "#8c57d1", "#5be7bd", "#ec8290"],
    fill: {
        type: 'pattern',
        opacity: 1,
        pattern: {
