...
var options = {
    ...
    colors: ['#206bc4', '#522c8f', '#ec8290', '#e68434'],
    legend: {
        position: 'right',
        offsetY: 40
    },
...
var options = {
    ...
    colors: ['#206bc4', '#8c57d1', '#e68434', '#5be7bd'],
    yaxis: {
        labels: {
            formatter: (val) => {
                return val / 1000 + 'K'
...
var options = {
    ...
    colors: ['#206bc4', '#522c8f', '#8c57d1', '#963b68', '#ec8290', "#eb9d59","#29aa85", "#62B7E5"],
    plotOptions: {
        bar: {
            columnWidth: '45%',
            distributed: true,
